...
from error_handle import SEND_WINDOW, RECEIVE_WINDOW, CACHE


# 将接收/发送窗口内相应的包序列号标记为已接收/被确认
def flag_set(window : Union[SEND_WINDOW, RECEIVE_WINDOW], \
             packet_seq_num : Union[int, List[Tuple[int, int]]], \
             packet_type : str = 'ACK') -> Union[SEND_WINDOW, RECEIVE_WINDOW]:
